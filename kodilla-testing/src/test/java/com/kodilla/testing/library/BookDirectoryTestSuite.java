...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf(){
        ...
        LibraryUser libraryUser1 = new LibraryUser("Jurek", "Killer", "111");
        LibraryUser libraryUser2 = new LibraryUser("Marek", "Malysz", "222");
        LibraryUser libraryUser3 = new LibraryUser("Kali", "Kowalski", "222");
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1)).thenReturn(listWith0Books);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser2)).thenReturn(listWith1Books);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser3)).thenReturn(listWith5Books);
        //When
